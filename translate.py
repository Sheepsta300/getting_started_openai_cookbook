...
class AzureTranslateTool(BaseTool):
    ...
    Attributes:
        translate_key (str): The API key used to authenticate requests with Azure Translator API.
        translate_endpoint (str): The endpoint URL for the Azure Translator API.
        translate_client (Any): An instance of the Azure Translator Client used for making API requests.
    """
